    ...
    <div className="w-full h-screen bg-[#0a192f] relative overflow-hidden" id="home">
      ...
      <div className="max-w-[1200px] mx-auto px-8 flex flex-col justify-center h-full relative z-10">
        ...
        <div className={`transition-all duration-1000 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
          ...
          <h1 className="text-5xl sm:text-7xl font-bold text-[#ccd6f6] mt-2">Dishant</h1>
        </div>
        
        <div className={`transition-all duration-1000 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
             style={{ transitionDelay: '0.5s' }}>
          <h2 className="text-4xl sm:text-6xl font-bold gradient-text mt-2">I'm a Full Stack Developer.</h2>
        </div>
        
        <div className={`transition-all duration-1000 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
             style={{ transitionDelay: '0.7s' }}>
          <p className="text-[#8892b0] max-w-[700px] text-lg leading-relaxed backdrop-blur-sm 
              bg-[#112240]/30 py-6 px-6 rounded-lg mt-6 border border-[#64ffda]/10 mx-auto sm:mx-0">
        ...
        <div className={`transition-all duration-1000 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
          ...
          <div className="flex flex-wrap gap-4 mt-4">
            ...
            <Link to="/contact">
              <button className="text-[#64ffda] border-[#64ffda] group border-2 px-6 py-3 my-2 flex items-center 
                hover:bg-[#64ffda]/10 transition-all duration-300 rounded-md font-medium">
                Contact Me
              </button>
            </Link>
          </div>
